...
public class HomeActivity extends AppCompatActivity implements HomeView {
    ...
    public void setMeal(List<Meals.Meal> meal) {
        ...
        headerAdapter.setOnItemClickListener((v, position) -> Toast.makeText(this, meal.get(position).getStrMeal(), Toast.LENGTH_LONG).show());
    }
    ...
    public void setCategory(List<Categories.Category> category) {
        ...
        homeAdapter.setOnItemClickListener((view, position) -> Toast.makeText(this, category.get(position).getStrCategory(), Toast.LENGTH_SHORT).show());
    }
